...
class State(object):
    ...
    def _createOAuthObjects(self):
        ...
        SPOTIPY_CLIENT_ID = 'aaa7d1c8c82147bfab3f3204da42a1ef'
        SPOTIPY_CLIENT_SECRET = 'af23a8c8a0c34d9ea42987cb02e4b987'
        if self.inProductionMode():
            SPOTIPY_REDIRECT_URI1 = 'https://pair-ify.herokuapp.com/callback1'
            SPOTIPY_REDIRECT_URI2 = 'https://pair-ify.herokuapp.com/callback2'
        else:
